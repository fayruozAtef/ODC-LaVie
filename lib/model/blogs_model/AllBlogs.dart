...
class AllBlogs {
  ...
  AllBlogs.fromJson(dynamic json) {
    _type = json['type'];
  ...
  String? _message;
  Data? _data;
AllBlogs copyWith({  String? type,
  String? message,
  Data? data,
}) => AllBlogs(  type: type ?? _type,
